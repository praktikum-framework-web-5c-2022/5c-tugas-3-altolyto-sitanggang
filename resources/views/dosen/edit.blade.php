               ...
               @endif 
                ...
                <div class="form-floating mb-3  ">
                    <select name="jenis_kelamin" placeholder="masukkan jenis kelamin" id="jeniskelamin" class="form-select">
                        <option value="Pria" {{ old('jenis_kelamin') ?? $dosen->jenis_kelamin == "Pria" ? "selected" : "" }}>Pria</option>
                        <option value="Wanita" {{ old('jenis_kelamin') ?? $dosen->jenis_kelamin == "Wanita" ? "selected" : "" }}>Wanita</option>
                    </select>
